package com.allianz.simplejhipster.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterChap1");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterChap1");
        ...
        config.getMapConfigs().put("com.allianz.simplejhipster.domain.*", initializeDomainMapConfig(jHipsterProperties));
